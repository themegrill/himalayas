...
class himalayas_featured_posts_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'background_image' ) ); ?>"> <?php esc_html_e( 'Image:', 'himalayas' ); ?> </label>
			<br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select category', 'himalayas' ); ?>
				:</label>
			<?php
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
		?>
		<div <?php echo esc_attr( $section_id ); ?> class="<?php echo $bg_image_class; ?>"
										...
										<div class="blog-content-wrapper">
											...
											<div class="posted-date">
												...
												<?php if ( has_category() ) { ?>
													<span>
													<?php
													esc_html_e( 'Posted in ', 'himalayas' );
													the_category( ', ' );
													?>
								</span>
												<?php } ?>
